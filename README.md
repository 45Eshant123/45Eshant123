# 💫 About Me:
🔭 Currently working on:<br>Full-stack web development, focusing on building scalable and high-performance web applications using modern frontend frameworks and reliable backend architectures.<br><br>🌱 Currently learning:<br>Advanced AI features, including intelligent automation, AI-driven analysis, and real-world integration of machine learning models into web applications.<br><br>👯 Looking to collaborate on:<br>Innovative web development and AI-based projects where I can learn, grow, and contribute as a 3rd-year student currently pursuing my degree.<br><br>💬 Ask me about:<br>Frontend & backend development, REST APIs, databases, AI-powered web applications, and building practical, real-world projects.<br><br>⚡ Fun fact:<br>I enjoy turning complex ideas into clean, efficient solutions—and I often optimize code just for the satisfaction of making it better 🚀


## 🌐 Socials:
[![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:iaseshantverma2014@gmail.com) 
